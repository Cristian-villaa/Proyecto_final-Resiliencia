...
Formatee el disco o partición/dev/sdd utilizando el sistema de archivos BtrFS .
...
Escribe la frase dentro de las comillas en un archivo nuevo llamadotest.txt dentro del subvolumen.
...
Liste el contenido de la instantánea montada para verificar que el archivotest.txt  sigue existiendo y fue recuperado allí.
